...
- `/asyncio-concurrency-basics`: Four minimal Python asyncio examples showing sequential vs concurrent execution with TaskGroup (3.11+) and gather, plus an error-handling comparison; includes timings and notes on structured concurrency.
